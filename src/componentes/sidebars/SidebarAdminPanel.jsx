...
export default function SidebarAdminPanel({ sidebarOpen, setSidebarOpen, user, sidebarOptions, selected, setSelected, handleLogout }) {
  return (
          ...
          <div className="d-flex align-items-center mt-3">
            ...
            {sidebarOpen && (
              <div className="text-white small">
                <span className="text-white-50">{user?.rol ? user.rol.charAt(0).toUpperCase() + user.rol.slice(1) : 'Rol'}</span>
