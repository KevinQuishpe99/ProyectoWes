...
import { login } from '../../servicios/auth/authSlice';
...
export default function LoginForm() {
  ...
  React.useEffect(() => {
    if (user) {
      ...
      else if (user.rol === 'organizador' && location.pathname !== '/organizador') {
        navigate('/organizador', { replace: true });
      }
      else if (user.rol === 'estudiante' && location.pathname !== '/usuario') {
